  ...
  return (
    <div className="min-h-screen pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-16 bg-white">
      ...
      <div className="relative mb-16">
        <div className="absolute inset-0 bg-blue-900 bg-opacity-5 rounded-2xl"></div>
        <div className="absolute -top-12 -right-12 w-64 h-64 bg-blue-500 rounded-full opacity-10 mix-blend-multiply blur-2xl"></div>
        <div className="absolute -bottom-12 -left-12 w-64 h-64 bg-purple-500 rounded-full opacity-10 mix-blend-multiply blur-2xl"></div>
        
        <div className="relative py-12 px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">Platform Statistics</h2>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className="bg-black bg-opacity-60 backdrop-blur-xl rounded-xl border border-blue-900 p-8 flex flex-col items-center text-center group transition-all duration-300 hover:border-blue-500 hover:translate-y-[-4px] hover:shadow-lg hover:shadow-blue-900/20"
              >
                <div className="inline-flex items-center justify-center h-16 w-16 bg-blue-900 bg-opacity-30 rounded-full mb-4 group-hover:scale-110 transition-transform">
                  {index === 0 && (
                ...
                <div className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-200 mb-2 group-hover:scale-110 transition-transform">{stat.value}</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div className="lg:col-span-2 bg-black bg-opacity-50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-800">
          <div className="p-8">
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center mb-2">
                  <div className="p-2 bg-blue-900 bg-opacity-50 rounded-lg mr-3">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-blue-900 bg-opacity-30 rounded-full h-20 w-20 flex items-center justify-center mx-auto mb-4 border border-blue-500">
              ...
              <h3 className="text-xl font-medium text-white mb-2">1. Find a Mentor</h3>
              <p className="text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-white mb-2">2. Connect Directly</h3>
              <p className="text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-white mb-2">3. Join the Network</h3>
              <p className="text-gray-300">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, index) => (
            <div key={index} className="bg-black bg-opacity-50 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-800 transform transition-all duration-300 hover:-translate-y-1 hover:border-blue-500">
              ...
              <div className="p-5">
                ...
                <p className="text-gray-400 text-sm mt-1">{member.university}</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="p-8 bg-gray-900 bg-opacity-50">
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-gray-800 bg-opacity-80 border border-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <textarea
                  className="w-full bg-gray-800 bg-opacity-80 border border-gray-700 text-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 h-32"
              ...
              <button
                type="submit"
                className="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition-colors w-full"
              >
                Send Message
              </button>
            </form>
      ...
      {/* CTA Section */}
      <div className="text-center">
        <Link to="/" className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-3 px-8 rounded-full hover:from-blue-700 hover:to-blue-900 transition-all shadow-lg hover:shadow-xl inline-flex items-center">
