                ...
                <div>
                  ...
                  <div className="space-y-3 bg-gray-900 bg-opacity-50 rounded-lg p-5 border border-gray-800">
                    <div className="flex items-center">
                      ...
                      <a href={`mailto:${academic.email || academic.name.toLowerCase().replace(' ', '.')}@example.com`} className="text-blue-400 hover:text-blue-300">
                        {academic.email || `${academic.name.toLowerCase().replace(' ', '.')}@example.com`}
                      </a>
                    </div>
                    
                    {academic.phone && (
                      <div className="mb-4">
                        <h3 className="font-medium text-gray-300 mb-2">Phone</h3>
                        <div className="flex items-center">
                          ...
                          <span className="text-gray-300">{academic.phone}</span>
                        </div>
                      </div>
                    )}
